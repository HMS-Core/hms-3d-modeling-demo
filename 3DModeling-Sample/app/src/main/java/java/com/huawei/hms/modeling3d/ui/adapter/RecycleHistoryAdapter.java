...
public class RecycleHistoryAdapter extends RecyclerView.Adapter<RecycleHistoryAdapter.DataViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DataViewHolder holder, int position) {
        ...
        switch (news.getStatus()) {
                ...
                holder.ivShowStatus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        dialog.getTvCancel().setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                dialog.dismiss();
                                if (!BaseUtils.getMemorySizeAndVersion(mContext)) {
                                    ...
                                    engine.previewModelWithConfig(news.getTaskId(), Modeling3dApp.app, config, new Modeling3dReconstructPreviewListener() {
                                        ...
                                        public void onError(String s, int i, String s1) {
                                            ((Activity) mContext).runOnUiThread(() -> {
                                                String message = s1;
                                                if (news.getTaskId().contains("2X")) {
                                                    message = "Preview is not supported.";
                                                }
                                    ...
                                    Toast.makeText(mContext, "Devices that support previewing materials or previewing 3D models must meet the following requirements: The device has a running memory of 4G and above, and the OS system is EMUI 8.0 and above or Android 8.0 and above.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
            ...
            case ConstantBean.MODEL_RISK_CONTROL_FAILED:
            ...
            case ConstantBean.MODEL_RISK_CONTROL_AUDIT_IN_PROGRESS:
